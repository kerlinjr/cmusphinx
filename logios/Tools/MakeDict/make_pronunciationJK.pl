...
use Getopt::Long;
#use lib 'C:\Users\jrkerlin\Documents\GitHub\cmusphinx\logios\Tools\MakeDict\lib';
#use Pronounce
my $usage = "usage: $0 -tools <dir> -dictdir <dir> -words <file> -handdict <file> -dict <file>\n";

my $toolsdir = "C:\\Users\\jrkerlin\\Documents\\GitHub\\cmusphinx\\logios\\Tools";
my $dictdir = "C:/TCDTIMIT/Sequencing";

my $words = "sentence.txt";  # input word list file
my $handdict = "CMUdict_with_dublin.txt"; # hand edited pronunciations
my $dict = "sentencePronounce.txt";   # output pronunciations file
